...
class Widget5(MMinteApp):
    ...
    def __init__(self):
        self.inputs = [
            {"type": "text",
             "key": 'analysis_folder',
             "label": "In this widget we are going to calculate growth rates and evaluate interactions for the species "
                      ...
                      "in the community and in isolation is created.<br><br>Enter the location of the folder "
